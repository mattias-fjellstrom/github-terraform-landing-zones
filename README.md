...
The blog posts discuss the setup when the target provider is Azure, the code for this example is found in the [azure](/terraform/azure/) directory.
...
If you want to try the **private registry** implementation apply the code in [terraform/private-registry](./terraform/private-registry/).
